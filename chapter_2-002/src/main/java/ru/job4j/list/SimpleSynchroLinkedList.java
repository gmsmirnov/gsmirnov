...
public class SimpleSynchroLinkedList<E> implements BaseList<E> {
    ...
    public Iterator<E> iterator() {
        return new SimpleSynchroLinkedListIterator<E>();
    }
    ...
    private class SimpleSynchroLinkedListIterator<E> implements Iterator<E> {
        ...
        /**
         * Creates iterator and initialises it.
         */
        public SimpleSynchroLinkedListIterator() {
            synchronized (SimpleSynchroLinkedList.this) {
                this.position = 0;
                this.expectedMod = SimpleSynchroLinkedList.this.modCount;
            }
        }
         ...
         *
         * @return true if this SimpleSynchroLinkedList contains next element.
         */
        @Override
