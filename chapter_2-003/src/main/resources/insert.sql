...
entry('1', 'test', 'test description', '2018-10-20 00:00:00','1', '1');

insert into items(author, title, description, creation_date, state, category)
entry('3', 'test2', 'test description 2', '2018-10-25 00:00:00','3', '1');

insert into items(author, title, description, creation_date, state, category)
entry('3', 'test3', 'test description 3', '2018-10-22 00:00:00','1', '3');

insert into items(author, title, description, creation_date, state, category)
entry('1', 'request1', 'request description 1', '2018-10-28 00:00:00','5', '5');

insert into items(author, title, description, creation_date, state, category)
entry('4', 'request', 'request description', '2018-10-27 00:00:00','5', '5');