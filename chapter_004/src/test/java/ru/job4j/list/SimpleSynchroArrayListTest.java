...
public class SimpleSynchroArrayListTest {
    ...
    private SimpleSynchroArrayList<Integer> intList;

    private Iterator<Integer> it;

    @Before
    public void init() {
        this.intList = new SimpleSynchroArrayList<Integer>(10);
        for (int i = 0; i < 5; i++) {
            this.intList.add(i);
        }
    ...
    private SimpleSynchroArrayList<Integer> syncList;
    ...
    public void multiThreadInit() {
        ...
        this.syncList = new SimpleSynchroArrayList<Integer>(1000);
    ...
    public void whenManyThreadsOperateWithTheList() {
        ...
        Integer[] expected1 = new Integer[50];
        for (int i = 0; i < expected1.length; i++) {
            expected1[i] = i;
        }
        Integer[] result1 = new Integer[50];
        for (int i = 0; i < this.syncList.size(); i++) {
